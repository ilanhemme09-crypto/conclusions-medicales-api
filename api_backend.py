...
# -*- coding: utf-8 -*-
"""
API Backend v4.5.1 - FIX ORDONNANCES
- Fix KeyError 'texte' dans ordonnances
- Chaque ligne contient un tableau 'elements' groupés
- Retours à la ligne UNIQUEMENT sur .. et >
"""
...
app = FastAPI(title="API Conclusions v4.5.1")
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 API v4.5.1 - Fix ordonnances + Structure lignes.elements")
