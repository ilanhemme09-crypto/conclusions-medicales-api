...
# -*- coding: utf-8 -*-
"""
API Backend v4.4.0 - FIX RETOURS À LA LIGNE
- Ajout flag isFirstInLine pour grouper les éléments par phrase
- Split UNIQUEMENT sur .. et >
- HDM fix
"""
...
app = FastAPI(title="API Conclusions v4.4.0")
...
def traiter_texte_complet(texte: str):
    ...
    try:
        ...
        for phrase in phrases:
            ...
            # Marquer le premier élément pour indiquer le début d'une nouvelle ligne
            if lignes_phrase:
                lignes_phrase[0]["isFirstInLine"] = True
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 API v4.4.0 - isFirstInLine + Split on .. + Conduite éditable")
