...
# -*- coding: utf-8 -*-
"""
API Backend v4.3.1 - CORRECTIONS + FORMAT FIX
- Slash (/) pour alternatives au lieu de (;)
- Split UNIQUEMENT sur points
- HDM fix
- Fix format categories et motifs pour renvoyer des tableaux
"""
...
app = FastAPI(title="API Conclusions v4.3.1+fix")
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 API v4.3.3 - Split sur .. + Conduite éditable + HDM titres outside")
